...
def build_model():
    ...
    l_d1 = lasagne.layers.DenseLayer(l, num_units=256, W=lasagne.init.Orthogonal('relu'), b=lasagne.init.Constant(0.1))
    ...
    l = lasagne.layers.FlattenLayer(l)
    l_d2 = lasagne.layers.DenseLayer(l, num_units=256, W=lasagne.init.Orthogonal('relu'), b=lasagne.init.Constant(0.1))
