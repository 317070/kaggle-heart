...
def build_model():
    ...
    # Regular model #
    #################
    input_key = "sliced:data:singleslice:difference:middle"
    ...
    l = lasagne.layers.NonlinearityLayer(l, nonlinearity=lasagne.nonlinearities.rectify)
    l = MaxPoolOver2DAxisLayer(l, pool_size=(2, 2), axis=(2,3), stride=(2,2))
    l_systole = CumSumLayer(lasagne.layers.DenseLayer(lasagne.layers.DropoutLayer(l),
                              num_units=600,
    ...
    l_diastole = CumSumLayer(lasagne.layers.DenseLayer(lasagne.layers.DropoutLayer(l),
                              num_units=600,
                              nonlinearity=lasagne.nonlinearities.softmax))
