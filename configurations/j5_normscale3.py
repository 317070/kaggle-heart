...
def build_model():
    ...
    l_systole = MuConstantSigmaErfLayer(ldsys3, sigma=10./np.sqrt(test_time_augmentations))
    ...
    l_diastole = MuConstantSigmaErfLayer(lddia3, sigma=15./np.sqrt(test_time_augmentations))
