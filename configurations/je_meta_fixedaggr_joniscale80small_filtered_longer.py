...
def build_model():
    ...
    import je_ss_jonisc80small_360_gauss_longer
    submodel = je_ss_jonisc80small_360_gauss_longer.build_model(l0_slices)
    ...
    return {
        ...
        "pretrained":{
            je_ss_jonisc80small_360_gauss_longer.__name__: submodel["outputs"],
        }
    }
