...
def build_model():
    ...
    import je_ss_jonisc64_leaky_convroll
    submodel = je_ss_jonisc64_leaky_convroll.build_model(l0_slices)
    ...
    return {
        ...
        "pretrained":{
            je_ss_jonisc64_leaky_convroll.__name__: submodel["outputs"],
        }
    }
