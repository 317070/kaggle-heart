...
def build_model():
    ...
    ldsys_rnn = rnn_layer(ldsys_pat_in, num_units=256, mask_input=layers.lin_slice_mask)
...
#    ldsys_rnn_drop = nn.layers.dropout(ldsys_rnn, p=0.5)
    ...
    lddia_rnn = rnn_layer(lddia_pat_in, num_units=256, mask_input=layers.lin_slice_mask)
