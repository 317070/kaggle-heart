...
#    l0_slices_enhanced = nn.layers.ConcatLayer([l0_slices, relloc_slices], axis=1)
    ...
    ldsys1dropenhanced = nn.layers.ConcatLayer([ldsys1drop, relative_slice_locations_slices], axis=1)
    ldsys2 = nn.layers.DenseLayer(ldsys1dropenhanced, num_units=512, W=nn.init.Orthogonal("relu"),b=nn.init.Constant(0.1), nonlinearity=nn.nonlinearities.rectify)
