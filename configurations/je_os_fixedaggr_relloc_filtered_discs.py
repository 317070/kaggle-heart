...
"""Se slice vgg with normalised scale.
"""
import functools
...
#    l0_slices_enhanced = nn.layers.ConcatLayer([l0_slices, relloc_slices], axis=1)
    ...
    l_pat_sys_aggr_mu_sigma = layers.JeroenLayerDiscs([l_pat_sys_ss_mu, l_pat_sys_ss_sigma, lin_slice_mask, l_scaled_slice_distances], rescale_input=1.)
    ...
    l_pat_dia_aggr_mu_sigma = layers.JeroenLayerDiscs([l_pat_dia_ss_mu, l_pat_dia_ss_sigma, lin_slice_mask, l_scaled_slice_distances], rescale_input=1.)
