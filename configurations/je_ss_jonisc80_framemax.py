...
def build_model(input_layer = None):
    ...
    subsample_factor = 2
    l0_slices_subsampled = nn.layers.SliceLayer(l0, axis=1, indices=slice(0, 30, subsample_factor))
    ...
    return {
        ...
        "meta_outputs": {
            "systole:musigma": l_systole_musigma,
            "diastole:musigma": l_diastole_musigma,
        },
        "regularizable": {
            ld1: l2_weight,
            ld2: l2_weight,
