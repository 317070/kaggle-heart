...
def build_model():
    ...
    ldsys3bottleneck = nn.layers.DenseLayer(ldsys2drop, num_units=10, W=nn.init.Orthogonal("relu"), b=nn.init.Constant(0.1), nonlinearity=nn.nonlinearities.rectify)
    ldsys3 = nn.layers.DenseLayer(ldsys3bottleneck, num_units=600, W=nn.init.Orthogonal("relu"), b=nn.init.Constant(0.1), nonlinearity=nn.nonlinearities.softmax)
    ...
    lddia3bottleneck = nn.layers.DenseLayer(lddia2drop, num_units=10, W=nn.init.Orthogonal("relu"), b=nn.init.Constant(0.1), nonlinearity=nn.nonlinearities.rectify)
    lddia3 = nn.layers.DenseLayer(lddia3bottleneck, num_units=600, W=nn.init.Orthogonal("relu"), b=nn.init.Constant(0.1), nonlinearity=nn.nonlinearities.softmax)
    ...
    return {
        ...
        "regularizable": {
            ldsys1: l2_weight,
            ldsys2: l2_weight,
            ldsys3bottleneck: l2_weight_out,
            ldsys3: l2_weight_out,
            lddia1: l2_weight,
            lddia2: l2_weight,
            lddia3bottleneck: l2_weight_out,
