...
def build_model():
    ...
    ldsys3drop = nn.layers.dropout(ldsys3, p=0.0)  # dropout at the output might encourage adjacent neurons to correllate
    ...
    lddia3drop = nn.layers.dropout(lddia3, p=0.0)  # dropout at the output might encourage adjacent neurons to correllate
