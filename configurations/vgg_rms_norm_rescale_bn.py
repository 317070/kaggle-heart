...
from nn_heart import batch_norm
...
def build_model():
    ...
    l = batch_norm(conv3(l_in, num_filters=64))
    l = batch_norm(conv3(l, num_filters=64))

    l = max_pool(l)

    l = batch_norm(conv3(l, num_filters=128))
    l = batch_norm(conv3(l, num_filters=128))

    l = max_pool(l)

    l = batch_norm(conv3(l, num_filters=256))
    l = batch_norm(conv3(l, num_filters=256))
    l = batch_norm(conv3(l, num_filters=256))

    l = max_pool(l)

    l = batch_norm(conv3(l, num_filters=512))
    l = batch_norm(conv3(l, num_filters=512))
    l = batch_norm(conv3(l, num_filters=512))
