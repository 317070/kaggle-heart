...
train_data_iterator = data_iterators.Ch2Ch4DataGenerator(data_path=PKL_TRAIN_DATA_PATH,
...
valid_data_iterator = data_iterators.Ch2Ch4DataGenerator(data_path=PKL_TRAIN_DATA_PATH,
                                                         batch_size=chunk_size,
...
test_data_iterator = data_iterators.Ch2Ch4DataGenerator(data_path=PKL_VALIDATE_DATA_PATH,
                                                        batch_size=chunk_size,
...
def build_model():
    l_in_ch2 = nn.layers.InputLayer((None, 30) + patch_size)
    l_in_ch4 = nn.layers.InputLayer((None, 30) + patch_size)
    l_ins = [l_in_ch2, l_in_ch4]
    l_in = nn.layers.ConcatLayer([l_in_ch2, l_in_ch4], axis=0)
    ...
    return namedtuple('Model', ['l_ins', 'l_outs', 'l_targets', 'l_top', 'mu_layers', 'sigma_layers'])(l_ins, l_outs,
                                                                                                       l_targets, l_top,
                                                                                                       mu_layers,
                                                                                                       sigma_layers)
