...
train_data_iterator = data_iterators.SliceFFTNormRescaleDataGenerator(data_path='/data/dsb15_pkl/pkl_splitted/train',
...
valid_data_iterator = data_iterators.SliceFFTNormRescaleDataGenerator(data_path='/data/dsb15_pkl/pkl_splitted/valid',
                                                                      batch_size=chunk_size,
...
test_data_iterator = data_iterators.SliceFFTNormRescaleDataGenerator(data_path='/data/dsb15_pkl/pkl_validate',
                                                                     batch_size=chunk_size,
...
def build_model(l_in=None):
    l_in = nn.layers.InputLayer((None, 1) + patch_size) if not l_in else l_in
