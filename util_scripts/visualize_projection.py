...
_HOUGH_ROI_PATHS = (
    os.path.expanduser('~/storage/users/jburms/data/kaggle_heart/pkl_train_slice2roi.pkl'),
    os.path.expanduser('~/storage/users/jburms/data/kaggle_heart/pkl_validate_slice2roi.pkl'),)
